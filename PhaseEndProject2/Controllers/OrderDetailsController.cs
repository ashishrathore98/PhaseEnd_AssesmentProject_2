...
namespace PhaseEndProject2.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(PhaseEndProject2DbContext context)
        {
            _context = context;
        }
        ...
        {
            var phaseEndProject2DbContext = _context.OrderDetail.Include(o => o.Order).Include(o => o.Product);
            return View(await phaseEndProject2DbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PhaseEndProject2DbContext.OrderDetail'  is null.");
            }
            var orderDetail = await _context.OrderDetail.FindAsync(id);
            if (orderDetail != null)
            {
